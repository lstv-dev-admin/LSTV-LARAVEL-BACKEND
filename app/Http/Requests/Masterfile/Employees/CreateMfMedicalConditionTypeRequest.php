...
class CreateMfMedicalConditionTypeRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'medical_condition_type_desc' => 'required|unique:mf_medical_condition_types,medical_condition_type_desc',
        ];
    }
