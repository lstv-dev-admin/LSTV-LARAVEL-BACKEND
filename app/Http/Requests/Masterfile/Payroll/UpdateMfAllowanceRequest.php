 ...
 */
class UpdateMfAllowanceRequest extends FormRequest
{
    ...
    {
        return [
            'allowance_desc' => 'required|string|max:50|unique:mf_allowances,allowance_desc',
    ...
    {
        return [
            'allowance_desc.required' => 'Allowance description is required',
            'allowance_desc.string' => 'Allowance description must be a string',
            'allowance_desc.max' => 'Allowance description must not exceed 50 characters',
            'allowance_desc.unique' => 'Allowance description already exists',
